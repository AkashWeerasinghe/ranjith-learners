...
public class DarkLightSwitchIcon implements AnimatedIcon {
    ...
    private Icon darkIcon = new FlatSVGIcon("com/ranjithlearners/img/dark.svg", 0.4f);
    private Icon lightIcon = new FlatSVGIcon("com/ranjithlearners/img/light.svg", 0.4f);
