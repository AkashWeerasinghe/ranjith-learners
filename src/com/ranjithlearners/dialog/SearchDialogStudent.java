 ...
 */
public class SearchDialogStudent extends javax.swing.JDialog {
    /**
     * Creates new form SearchDialog
     */
    public SearchDialogStudent(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchDialogStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchDialogStudent dialog = new SearchDialogStudent(new javax.swing.JFrame(), true);
